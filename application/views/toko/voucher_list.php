<h4 class="fw-bold mb-4"><i class="bi bi-ticket-perforated me-2"></i>Voucher Toko</h4>
...
<div class="col-md-5">
    <div class="card border-0 shadow-sm mb-3">
        ...
        <div class="card-body">
            <?= form_open('toko/voucher/tambah') ?>
            <div class="mb-3">
                <label class="form-label fw-semibold">Kode Voucher</label>
                <input type="text" name="kode" class="form-control text-uppercase" placeholder="TOKOKU10" required>
            </div>
...
<div class="col-md-7">
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white fw-semibold">Voucher Toko Kamu</div>
            ...
            <table class="table mb-0">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="<?= base_url('toko/voucher/nonaktifkan/' . $v->id) ?>" class="btn btn-sm btn-outline-warning" onclick="return confirm('Nonaktifkan voucher ini?')">Nonaktifkan</a>
                        <?php endif; ?>
                        <a href="<?= base_url('toko/voucher/hapus/' . $v->id) ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Hapus voucher ini?')"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
